...
import { AUTHORS, authorMark, getArticlesByAuthor } from "@/lib/authors";
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 pt-14 pb-24 md:pt-20 md:pb-32">
      <div className="mb-10 flex flex-wrap items-end justify-between gap-4 md:mb-12">
        <div>
          <h1 className="font-heading text-3xl tracking-[-1px] text-white italic md:text-4xl">
            Authors
          </h1>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-4">
                <span
                  aria-hidden
                  className="font-display flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bay-500/20 text-xs font-bold tracking-wide text-bay-200 transition-transform duration-300 group-hover:scale-105"
                >
